...
namespace MHCockpit.VLPipe.Editor
{
    ...
    public static class BuildAndUploadToS3
    {
        ...
        /// Uses ToAddressableKey() from ProjectSetupWizard to keep the S3 path
        /// consistent with the topic naming convention.
        /// </summary>
        private static string BuildS3Prefix(ModuleConfig cfg, string buildTarget) =>
            $"Modules/{cfg.board}/{cfg.grade}/{cfg.subject}/{ProjectSetupWizard.ToAddressableKey(cfg.topic)}/{buildTarget}/";
